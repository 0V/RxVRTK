...
namespace RxVRTK
{
    public static class RxVRTK_HeightAdjustTeleportExtension
    {
        ...
        /// <returns></returns>
        public static IObservable<DestinationMarkerEventArgs> TeleportingAsObservable(this VRTK_HeightAdjustTeleport events)
        {
