...
namespace RxVRTK
{
    public static class RxVRTK_SimplePointerExtension
    {
        ...
        /// <returns></returns>
        public static IObservable<DestinationMarkerEventArgs> DestinationMarkerEnterAsObservable(this VRTK_SimplePointer events)
        {
        ...
        /// <param name="events"></param>
        /// <returns></returns>
        public static IObservable<DestinationMarkerEventArgs> DestinationMarkerExitAsObservable(this VRTK_SimplePointer events)
        {
            return Observable.FromEvent<DestinationMarkerEventHandler, DestinationMarkerEventArgs>(
                 h => (s, e) => h(e),
        ...
        /// <param name="events"></param>
        /// <returns></returns>
        public static IObservable<DestinationMarkerEventArgs> DestinationMarkerHoverAsObservable(this VRTK_SimplePointer events)
        {
            return Observable.FromEvent<DestinationMarkerEventHandler, DestinationMarkerEventArgs>(
                 h => (s, e) => h(e),
